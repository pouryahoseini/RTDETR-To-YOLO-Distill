...
if __name__ == '__main__':
    ...
    # python ./src/cvperception/zoo/rtdetr/conver_params.py -c configs/rtdetr/rtdetr_r50vd_120e_coco.yml -p rtdetr_r50vd_1x_objects365.pdparams -o rtdetr_r50vd_1x_objects365_new.pth -v 2
